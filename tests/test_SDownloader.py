...
class TestSDownloader(TestCase):
    ...
    def test_download(self):
        ...
        self.assertEqual(len(downloader1._SDownloader__download_paths([1999])), 30)
        self.assertEqual(len(downloader2._SDownloader__download_paths([1999, 2000, 20001, 2018])), 120)
        self.assertEqual(downloader1._SDownloader__download_paths([1999])[0],
                         (("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&s"
        ...
        self.assertEqual(downloader1._SDownloader__download_paths([1999])[-1],
                         (("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&s"
        ...
        self.assertEqual(downloader2._SDownloader__download_paths([2000, 2018])[0],
                         (("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&s"
        ...
        self.assertEqual(downloader2._SDownloader__download_paths([2000, 2018])[-1],
                         (("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&s"
        ...
        self.assertEqual(downloader2._SDownloader__download_paths([2010])[16],
                         (("https://baseballsavant.mlb.com/statcast_search/csv?all=true&hfPT=&hfAB=&hfBBT=&hfPR=&hfZ=&s"
